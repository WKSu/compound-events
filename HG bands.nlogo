...
to go
  ...
  change_bands_known_locations_based_on_season
...
to change_bands_known_locations_based_on_season
  ask turtles[
    if current_season = 0[
...
to gather_move_explore
  ...
  [
    ...
    [
      ...
      foreach known_locations_current [x -> if (item 1 x >= food_needed and item 2 x >= resources_needed)
